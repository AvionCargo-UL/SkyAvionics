...
def test_pymavlink():
    ...
    mission_items: List[MAVLink_mission_item_message] = [
        master.mav.mission_item_encode(
            ...
            mavutil.mavlink.MAV_CMD_NAV_TAKEOFF, 0, 0, 0, 0, 0, 0, 0, 0, 10),  # Takeoff
        master.mav.mission_item_encode(
            0, 0, 1, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT,
            mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, 37.874, -122.259, 10),  # Waypoint 1
        master.mav.mission_item_encode(
    ...
    for i, item in enumerate(mission_items):
        ...
        master.mav.mission_item_send(target_system=item.target_system,
